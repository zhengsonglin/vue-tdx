<template>
    <div class="page-index bg-fff h100 over-auto refundDetial">
        <div class="header-wrap">
            <van-nav-bar title="申请售后" left-text="" right-text="" left-arrow fixed z-index="10" class="header"
        ...
        <div class="content">
            ...
            <div class="form-group">
                <div class="cell-row bottom-line">
                    <van-field readonly :value="form.reason" label="售后原因" placeholder="" is-link
                ...
                <div class="cell-row bottom-line" v-if="form.reason =='差价售后' || refundBaseInfo.RefundReason =='资金问题'">
                    ...
                    <div class="return_rea_left text-r" style="margin-top:3px;color:darkgray;">
                        （ 任务金额：￥<span id="rwje" style="margin-right: 20px;">{{toDecimal2(refundBaseInfo.YPrice)}}</span>差价金额：<span
                            id="RefundMoney">{{refundBaseInfo.DiffAmount || 0}}</span> ）
                    </div>
                </div>
                <div class="cell-row bottom-line">
                    ...
                    <van-field name="uploader" label=" ">
                        <template #input>
                            <van-uploader v-model="fileList" :before-read="beforeRead" :after-read="afterRead" multiple
                                          :max-count="3" accept="image/png, image/jpeg, image/jpg"
    ...
    export default {
        ...
        methods: {
            ...
            deletePreview(file, {name, index}) {
                console.log(name, this.fileList, index, file)
