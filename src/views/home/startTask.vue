                ...
                <div class="right-text flex-1">
                    ...
                    <div class="select_Key" v-if="taskInfo.FSelectKey !=2 ">
                        ...
                        <div class="keyword-inp">
                            ...
                            <van-button type="danger" v-clipboard:copy="taskInfo.keyword" v-clipboard:success="onCopy"
                    ...
                    <div class="select_Key select_Key_2" v-if="taskInfo.FSelectKey !=1 ">
                        ...
                        <div class="keyword-inp">
                            ...
                            <van-button type="danger" v-clipboard:copy="taskInfo.FCommodityKey"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTaskInfo() {
                this.API.getTaskInfo({order_id: this.taskId}).then(({data}) => {
                    this.taskInfo = data
                })
            },
            //验证商品价格
            ...
            validProductLink() {
                if (this.productLink == "") {
                    ...
                    this.API.checkGoodsUrl({
                        "order_id": this.taskId,
                        "product_url": encodeURI(this.productLink)
                    }).then((data) => {
                        if (data.ErrorCode == 100) {
