<template>
    <div class="page-single w100 h100 over-auto">
        <div class="header-wrap">
            <van-nav-bar title="马上抢" left-text="" right-text="" left-arrow fixed z-index="10" class="header"
                        ...
                        <div class="product-info">
                            ...
                            <div class="progress">
                                <div class="bar_box inline-block h100"
                                     :style="{width:percent(item.remain_count/item.task_count, 0)}"></div>
                            ...
                            <div class="pro-num">
                                <p>已抢 <span class="red">{{item.task_count - item.remain_count}}</span>件 共 <span
                                        class="red">{{item.task_count}}件</span></p>
                                <p>任务金额:<span class="red">{{toDecimal2(item.price)}}元</span>返还金额:<span class="red">{{toDecimal2(item.price)}}</span>
                                </p>
    ...
    export default {
        ...
        methods: {
            ...
            getSingleProductList() {
                this.API.getSingleProductList({pa_id: this.paId}).then(({data}) => {
                    this.result = data
                })
            },
