        ...
        <div class="content">
            <div class="register-form">
                <div class="login-input text-input">
                    <input type="text" id="txt_UserName" class="input-height" v-model.trim="form.username"
                           placeholder="请输入账号">
                </div>
                <div class="login-input pass-input">
                    <input type="digit" id="txt_Yzm" class="input-height" v-model.trim="form.yzm" placeholder="请输入验证码"
                           maxlength="6">
                    <div class="reg-get-code">
                        <van-button type="warning" @click="sendCode" size="mini" :disabled="validCode.isDisabled">
                            {{validCode.btnText}}
                        </van-button>
                    </div>
                </div>
                <div class="login-input pass-input">
                    <input type="password" id="txt_PassWord" class="input-height" v-model.trim="form.pwd"
                           placeholder="请输入密码">
                </div>
                <div class="login-input pass-input">
                    <input type="password" id="txt_RePassWord" class="input-height" v-model.trim="form.repwd"
                           placeholder="再次输入登录密码">
                </div>
                <div class="login-input text-input">
                    <input type="text" id="txt_Code" class="input-height" v-model.trim="form.code"
                           placeholder="请输入邀请码（比填）" maxlength="8">
                </div>
                <div class="other">
                ...
                <div class="btn-grop c-fff text-c">
                    <van-button type="primary" block @click="handleRegister" :loading="loginBtn.isLoading"
                                :loading-text="loginBtn.loadingText">注册
                    </van-button>
                </div>
            </div>
        </div>
