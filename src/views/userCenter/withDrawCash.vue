    ...
    <div class="page-index withDrawCash bg-fff h100 over-auto">
        ...
        <div class="content">
            <van-cell-group>
                ...
                <van-field label="姓名 :" :value="withDrawCashInfo.real_name" readonly input-align="right"
                           label-align="right"/>
                <van-field label="银行名称 :" :value="withDrawCashInfo.bank" readonly input-align="right"
                           label-align="right"/>
                <van-field label="银行卡号 :" :value="withDrawCashInfo.bank_card" readonly input-align="right"
                           label-align="right"/>
                <van-field label="提现金额 :" :value="toDecimal2(withDrawCashInfo.balance)" readonly input-align="right"
                           label-align="right"/>


            </van-cell-group>
            <van-button block color="linear-gradient(to right, #4bb0ff, #6149f6)" @click="submit" class="btn-submit">
                提交申请
            </van-button>
