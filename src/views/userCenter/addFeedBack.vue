<template>
	<div class="page-index bg-fff h100 over-auto addFeedBack">
		<div class="header-wrap">
			<van-nav-bar :title="title" left-text="" right-text="" left-arrow fixed z-index="10" class="header" @click-left="onClickLeft"/>
		</div>
		<div class="content">
			<div class="form-group">
				<div class="cell-row">
					...
					<div class="cell-input">
				  		<input type="text" class="title-input w100" v-model.trim="form.title" placeholder="请输入反馈标题" :readonly="isDetail"/>
				  	</div>
				</div>
