<template>
    <div class="page-index reservationRecord bg-fff h100 over-auto">
        <div class="header-wrap">
            <van-nav-bar title="预定任务明细" left-text="" right-text="" left-arrow fixed z-index="10" class="header"
            ...
            deleteUserReserve(item) {
                this.API.deleteUserReserve({fid: item.FID}).then((data) => {
                    if (data.ErrorCode == 100) {
                        ...
                        let url = "/MobileUserCenter/ReservationRecord";
